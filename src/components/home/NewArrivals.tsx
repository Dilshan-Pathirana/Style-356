...
export function NewArrivals() {
  ...
  return (
    <section className="py-12 md:py-20 bg-offwhite overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-end justify-between mb-6 md:mb-10">
          ...
          <Link
            to="/new-arrivals"
            className="hidden md:flex items-center gap-2 text-charcoal hover:text-gold transition-colors font-medium group"
          >
            View All{' '}
        ...
        <div
          ref={scrollRef}
          className="flex overflow-x-auto gap-4 md:gap-6 pb-6 md:pb-8 -mx-4 px-4 md:mx-0 md:px-0 no-scrollbar snap-x snap-mandatory"
        >
          ...
          <div className="min-w-[200px] flex items-center justify-center md:hidden snap-start">
            <Link
              to="/new-arrivals"
              className="flex flex-col items-center gap-3 text-charcoal"
            >
